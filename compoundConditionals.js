...
let secretUsername = ("blesssed");
let secretPassword = ("24/7");
...
button.addEventListener("click", function() {
    ...
    if( uername === secretUsername && password === secretPassword) {
    ...
    } else if (username === "" || password === "You need to enter SOMETHING."){
        message.innerHTML = ""
    } else {
